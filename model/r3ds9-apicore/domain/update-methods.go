...
func (ud *UpdateDocument) SetMembers(p []DomainMember) *UpdateDocument {
	mName := fmt.Sprintf(MEMBERS)
	ud.Set().Add(func() bson.E {
		return bson.E{Key: mName, Value: p}
	})
	return ud
...
func (ud *UpdateDocument) setOrUnsetMembers(p []DomainMember, um UnsetMode) {
...
func UpdateWithMembers(p []DomainMember) UpdateOption {
	return func(ud *UpdateDocument) {
		if len(p) > 0 {
			ud.SetMembers(p)
		} else {
...
// ----- [] - struct - DomainMember [members.[]]
// SetMembersI No Remarks
func (ud *UpdateDocument) SetMembersI(ndxI int, p DomainMember) *UpdateDocument {
	mName := fmt.Sprintf(MEMBERS_I, ndxI)
	ud.Set().Add(func() bson.E {
		return bson.E{Key: mName, Value: p}
	})
	return ud
...
// UnsetMembersI No Remarks
func (ud *UpdateDocument) UnsetMembersI(ndxI int) *UpdateDocument {
	mName := fmt.Sprintf(MEMBERS_I, ndxI)
	ud.Unset().Add(func() bson.E {
		return bson.E{Key: mName, Value: ""}
	})
...
// setOrUnsetMembersI No Remarks
func (ud *UpdateDocument) setOrUnsetMembersI(ndxI int, p DomainMember, um UnsetMode) {
	if !p.IsZero() {
		ud.SetMembersI(ndxI, p)
	} else {
		switch um {
		case KeepCurrent:
		case UnsetData:
			ud.UnsetMembersI(ndxI)
		case SetData2Default:
			ud.UnsetMembersI(ndxI)
		}
	}
...
//----- code - string -  [members.[].code members.code]

// SetMembersICode No Remarks
func (ud *UpdateDocument) SetMembersICode(ndxI int, p string) *UpdateDocument {
	mName := fmt.Sprintf(MEMBERS_I_CODE, ndxI)
	ud.Set().Add(func() bson.E {
		return bson.E{Key: mName, Value: p}
	})
	return ud
...
// UnsetMembersICode No Remarks
func (ud *UpdateDocument) UnsetMembersICode(ndxI int) *UpdateDocument {
	mName := fmt.Sprintf(MEMBERS_I_CODE, ndxI)
	ud.Unset().Add(func() bson.E {
		return bson.E{Key: mName, Value: ""}
	})
...
// setOrUnsetMembersICode No Remarks
func (ud *UpdateDocument) setOrUnsetMembersICode(ndxI int, p string, um UnsetMode) {
	if p != "" {
		ud.SetMembersICode(ndxI, p)
	} else {
		switch um {
		case KeepCurrent:
		case UnsetData:
			ud.UnsetMembersICode(ndxI)
		case SetData2Default:
			ud.UnsetMembersICode(ndxI)
		}
	}
...
func UpdateWithMembersICode(ndxI int, p string) UpdateOption {
	return func(ud *UpdateDocument) {
		if p != "" {
			ud.SetMembersICode(ndxI, p)
		} else {
...
//----- objType - string -  [members.[].objType members.objType]

// SetMembersIObjType No Remarks
func (ud *UpdateDocument) SetMembersIObjType(ndxI int, p string) *UpdateDocument {
	mName := fmt.Sprintf(MEMBERS_I_OBJTYPE, ndxI)
	ud.Set().Add(func() bson.E {
		return bson.E{Key: mName, Value: p}
	})
	return ud
...
// UnsetMembersIObjType No Remarks
func (ud *UpdateDocument) UnsetMembersIObjType(ndxI int) *UpdateDocument {
	mName := fmt.Sprintf(MEMBERS_I_OBJTYPE, ndxI)
	ud.Unset().Add(func() bson.E {
		return bson.E{Key: mName, Value: ""}
	})
...
// setOrUnsetMembersIObjType No Remarks
func (ud *UpdateDocument) setOrUnsetMembersIObjType(ndxI int, p string, um UnsetMode) {
	if p != "" {
		ud.SetMembersIObjType(ndxI, p)
	} else {
		switch um {
		case KeepCurrent:
		case UnsetData:
			ud.UnsetMembersIObjType(ndxI)
		case SetData2Default:
			ud.UnsetMembersIObjType(ndxI)
		}
	}
...
func UpdateWithMembersIObjType(ndxI int, p string) UpdateOption {
	return func(ud *UpdateDocument) {
		if p != "" {
			ud.SetMembersIObjType(ndxI, p)
		} else {
